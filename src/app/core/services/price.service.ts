...
export class PriceService {
  ...
  getTopCryptos(vsCurrency: string = 'usd'): Observable<Crypto[]> {
    ...
    return this.cacheService.getOrFetch(cacheKey, this.LIST_CACHE_TTL, () =>
      this.http.get<Crypto[]>(
  ...
  getCryptoDetail(id: string, vsCurrency: string = 'usd'): Observable<Crypto> {
    ...
    return this.cacheService.getOrFetch(cacheKey, this.DETAIL_CACHE_TTL, () =>
      this.http
